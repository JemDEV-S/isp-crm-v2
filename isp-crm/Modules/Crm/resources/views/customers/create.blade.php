...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-secondary-500">Complete la información del cliente</p>
        </div>
            ...
            <x-card title="Tipo de Cliente" class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <option value="personal" {{ old('customer_type') === 'personal' ? 'selected' : '' }}>Personal</option>
            ...
            <x-card title="Configuración Adicional" class="mb-6">
                <div class="space-y-3">
                    <label class="flex items-center">
                        <input type="checkbox" name="tax_exempt" value="1" {{ old('tax_exempt') ? 'checked' : '' }}
