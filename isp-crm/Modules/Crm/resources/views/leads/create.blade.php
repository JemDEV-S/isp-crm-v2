...
@section('breadcrumb')
    ...
    <span class="text-secondary-900 font-medium">Crear Prospecto</span>
@endsection
...
@section('content')
    <div class="max-w-3xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-secondary-900">Crear Nuevo Prospecto</h1>
            <p class="mt-1 text-sm text-secondary-500">Complete la información del prospecto comercial</p>
        </div>
        ...
        <form action="{{ route('crm.leads.store') }}" method="POST">
            ...
            <x-card title="Información del Prospecto" class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <option value="campaign" {{ old('source') === 'campaign' ? 'selected' : '' }}>Campaña</option>
                    </x-select>
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-button type="submit" icon="check">Crear Prospecto</x-button>
            </div>
        </form>
    </div>
@endsection
