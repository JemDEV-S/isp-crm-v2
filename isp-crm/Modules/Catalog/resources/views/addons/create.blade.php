...
@section('breadcrumb')
    ...
    <span class="text-secondary-900 font-medium">Crear Addon</span>
@endsection
...
@section('content')
    <div class="max-w-3xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-secondary-900">Crear Addon</h1>
            <p class="mt-1 text-sm text-secondary-500">Complete la información para crear un nuevo servicio adicional</p>
        </div>

        <!-- Formulario -->
        <form action="{{ route('catalog.addons.store') }}" method="POST">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            placeholder="Descripción detallada del addon..."
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-button type="submit" icon="check">Crear Addon</x-button>
            </div>
        </form>
    </div>
@endsection
