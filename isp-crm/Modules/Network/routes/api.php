...
Route::middleware(['auth:sanctum'])->prefix('v1/network')->name('api.network.')->group(function () {
    // Nodes
    ...
    Route::apiResource('nap-boxes', NapBoxController::class);

    // Provisioning
    Route::post('provisioning/check-feasibility', [NapBoxController::class, 'checkFeasibility'])->name('provisioning.check-feasibility');
});
