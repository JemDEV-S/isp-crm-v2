...
@section('breadcrumb')
    ...
    <x-icon name="chevron-right" class="w-4 h-4 text-secondary-400" />
    <span class="text-secondary-900 font-medium">Nuevo Dispositivo</span>
@endsection

@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-secondary-900">Registrar Nuevo Dispositivo</h1>
            <p class="mt-1 text-sm text-secondary-500">
                Complete la información para dar de alta un nuevo dispositivo de red (Router, OLT, Switch, etc.).
            </p>
        </div>

        <form action="{{ route('network.devices.store') }}" method="POST">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <x-input
                            ...
                            hint="Se encriptará automáticamente"
                        />
                    </div>
                </div>
            </x-card>
